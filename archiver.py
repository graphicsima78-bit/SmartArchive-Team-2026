...
from file_analyzer import (
    ANDROID_APP_EXTS, ARCH_EXTS, AUDIO_EXTS, CODE_EXTS, DATA_EXTS, DATABASE_EXTS,
    GAME_EXTS, IMAGE_EXTS, IOS_APP_EXTS, ISO_EXTS, LINUX_APP_EXTS,
    LINUX_ARCHIVE_EXTS, MAC_APP_EXTS, OPENDOCUMENT_EXTS, OTHER_EXTS, PDF_EXTS,
    POWERPOINT_EXTS, TEXT_EXTS, THREE_D_EXTS, VECTOR_EXTS, VIDEO_EXTS, WEB_EXTS,
